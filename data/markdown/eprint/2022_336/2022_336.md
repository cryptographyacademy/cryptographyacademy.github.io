...
- <span id="page-51-18"></span>[AGH10] Jae Hyun Ahn, Matthew Green, and Susan Hohenberger. Synchronized aggregate signatures: new definitions, constructions and applications. In ACM CCS, 2010.
...
- <span id="page-51-13"></span>[BHK17] Zvika Brakerski, Justin Holmgren, and Yael Tauman Kalai. Non-interactive delegation and batch NP verification from standard computational assumptions. In STOC, 2017.
- <span id="page-51-7"></span>[BISW17] Dan Boneh, Yuval Ishai, Amit Sahai, and David J. Wu. Lattice-based SNARGs and their application to more efficient obfuscation. In EUROCRYPT, 2017.
...
- <span id="page-52-10"></span>[GS08] Jens Groth and Amit Sahai. Efficient non-interactive proof systems for bilinear groups. In EUROCRYPT, 2008.
...
- <span id="page-52-6"></span>[GZ21] Alonso González and Alexandros Zacharakis. Succinct publicly verifiable computation. In TCC, 2021.
...
- <span id="page-53-3"></span>[PHGR13] Bryan Parno, Jon Howell, Craig Gentry, and Mariana Raykova. Pinocchio: Nearly practical verifiable computation. In IEEE Symposium on Security and Privacy, 2013.
...
- <span id="page-53-17"></span>[RR20] Guy N. Rothblum and Ron D. Rothblum. Batch verification and proofs of proximity with polylog overhead. In TCC, 2020.
...
- <span id="page-53-16"></span>[RRR18] Omer Reingold, Guy N. Rothblum, and Ron D. Rothblum. Efficient batch verification for UP. In CCC, 2018.
...
- <span id="page-53-1"></span>[Set20] Srinath T. V. Setty. Spartan: Efficient and general-purpose zkSNARKs without trusted setup. In CRYPTO, 2020.
